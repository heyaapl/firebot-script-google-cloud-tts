...
// Chirp (formerly Journey) voices lack certain functionality (rate/pitch adjustment, a-law encoding).
function nonChirpVoices() {
    return allVoices.filter(v => !v.name.includes("Chirp"));
};
